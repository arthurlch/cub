...
func (es *EditorState) InsertRunes(keyEvent termbox.Event, fileType string) {
	st := es.State
...
func (es *EditorState) DeleteRune(fileType string) {
	st := es.State
...
func (es *EditorState) InsertNewLine(fileType string) {
	st := es.State
